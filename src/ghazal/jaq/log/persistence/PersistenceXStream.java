package ghazal.jaq.log.persistence;
...
public abstract class PersistenceXStream {
    ...
    public static Logiciel initializeModelManager(String fileName) {
        ...
        if (file.exists()) {
            log = (Logiciel) loadFromXMLwithXStream();
        } else {
            try {
                file.createNewFile();
            } catch (IOException e) {
